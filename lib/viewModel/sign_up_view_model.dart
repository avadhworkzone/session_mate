...
class SignUpViewModel extends GetxController {
  ...
  Rx<TextEditingController> signUpUserNameController = TextEditingController().obs;
  Rx<TextEditingController> signUpPhoneNoController = TextEditingController().obs;
  Rx<TextEditingController> signUpPasswordController = TextEditingController().obs;
  Rx<TextEditingController> signUpConfirmPasswordController = TextEditingController().obs;
