        ...
        SizedBox(
          ...
          child: TextFormField(
            ...
            validator: (value) {
              return isValidate == false
                  ...
                  : value!.isEmpty
                      ...
                      : validationType == ValidationTypeEnum.email
                          ? ValidationMethod.validateEmail(value)
                          : validationType == ValidationTypeEnum.mapScreenField
                              ? ValidationMethod.defaultValidation(value)
                              // : validationType == ValidationTypeEnum.name
                              //     ? ValidationMethod.validateName(value)
                              //     : validationType == ValidationTypeEnum.address
                              //         ? ValidationMethod.validateAddress(value)
            ...
            decoration: InputDecoration(
              ...
              //     borderSide: BorderSide(color: AppColors.white),
              //     borderRadius: BorderRadius.circular(10.r)),
              border: isOutlineInputBorder == true
                  ? OutlineInputBorder(
                      borderSide: BorderSide(
                          color: borderColor ??
              ...
              focusedBorder: isOutlineInputBorder == true
                  ...
                  : UnderlineInputBorder(
                      borderSide: BorderSide(
                          color: borderColor ??
                              AppColors.black1c.withOpacity(0.4))),
              disabledBorder: isOutlineInputBorder == true
                  ? OutlineInputBorder(
                      borderSide: BorderSide(
                          color: borderColor ??
                              AppColors.black1c.withOpacity(0.4)))
              ...
              enabledBorder: isOutlineInputBorder == true
                  ...
                  : UnderlineInputBorder(
                      borderSide: BorderSide(
                          color: borderColor ??
                              AppColors.black1c.withOpacity(0.4))),
              prefixIcon: isNotShowPreIcon ?? true
                  ? const SizedBox(
                      width: 20,
                    )
                  : Row(
