...
class _SignInScreenState extends State<SignInScreen> {
                            ...
                            child: Form(
                              ...
                              child: Column(
                                children: [
                                  CommonDropdownField(
                                      onChanged: (val) =>
                                          signInViewModel.dropDownChange(val)),
                                  SizeConfig.sH20,
                                  ...
                                  signInViewModel.signInRoleVal.value ==
                                      ...
                                      : CommonTextField(
                                          // readOnly:
                                          //     signInViewModel.isReadOnly.value,
                                  ...
                                  CustomBtn(
                                    ...
                                    onTap: () {
                                      signInViewModel
                                          .signInPhoneIsValidate.value = true;
                                      ...
                                      InkWell(
                                        onTap: () {
                                          ...
                                          signInViewModel
                                              .signInPasswordController.value
                                              .clear();
                                          signInViewModel.signInPhoneIsValidate
                                              .value = false;
  ...
  onLoginTap() async {
    ...
    model.role = signInViewModel.signInRoleVal.value;
    model.centerCode = signInViewModel.therapyCenterCodeController.value.text;
...
class _SignInScreenState extends State<SignInScreen> {
                              ...
                              child: Column(
                                children: [
                                  ...
                                  CommonTextField(
                                    ...
                                    textEditController: signInViewModel
                                        .signInRoleController.value,
                                    contentPadding:
                                        EdgeInsets.only(bottom: 9.w, top: 6.w),
                                  ),
                                  // CommonDropdownField(onChanged: (val) => signInViewModel.dropDownChange(val)),

                                  /*      signInViewModel.signInRoleVal.value == AppStrings.caregiver
                                      ? const SizedBox()
                                      : CommonTextField(
                                          // readOnly:
                                          //     signInViewModel.isReadOnly.value,
                                          textEditController: signInViewModel.therapyCenterCodeController.value,
                                          title: AppStrings.therapyCenterCode,
                                          validationType: ValidationTypeEnum.password,
                                          regularExpression: RegularExpressionUtils.therapyCenterCode,
                                  ...
                                  signInViewModel.signInRoleVal.value == AppStrings.caregiver ? const SizedBox() : SizeConfig.sH20,
                                  Column(
                                    children: [
                                       CommonTextField(
                                        // readOnly:
                                      ...
                                      CommonTextField(
                                        ...
                                        textEditController: signInViewModel.signInPasswordController.value,
                                        keyBoardType: TextInputType.text,
                                        textInputAction: TextInputAction.done,
                                        contentPadding: EdgeInsets.symmetric(
                                          vertical: 7.w,
                                        ...
                                        preFixIconPath: AppImageAssets.passwordIcon,
                                        validationType: ValidationTypeEnum.password,
                                        obscureValue: signInViewModel.signInShowPass.value == true ? false : true,
                                        sIcon: InkWell(
                                          onTap: () {
                                            signInViewModel.signInShowPass.value = !signInViewModel.signInShowPass.value;
                                          },
                                          child: LocalAssets(
                                            imagePath: signInViewModel.signInShowPass.value == true ? AppImageAssets.eyeIcon : AppImageAssets.passwordViewIcon,
                                            height: 22.w,
                                          ),
                                        ),
                                        isValidate: true,
                                  ...
                                  CustomBtn(
                                    ...
                                    onTap: () {
                                      ...
                                      if (signInFormKey.currentState!
                                          .validate()) {
                                        /* if (signInViewModel.signInRoleVal.value == '') {
  ...
  onLoginTap() async {
    ...
    model.email = signInViewModel.signInEmailController.value.text;
    model.mobileNumber = signInViewModel.signInPhoneNoController.value.text;
    print("Mobile Number :- ${model.mobileNumber} ${model.email}");
    final status = await AuthService.checkLoginCredential(model);
    print("status :- $status");
    ...
    if (status) {
      ...
      print(
          "Login Number :- ${signInViewModel.signInPhoneNoController.value.text}");
      // await PreferenceManagerUtils.setUserId(model.mobileNumber ?? '');
      // hideLoadingDialog(context: context);
      // PreferenceManagerUtils.setLoginExist('true');
    } else {
