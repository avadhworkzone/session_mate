    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Obx(
          () => Column(
            children: [
              commonAppBar(title: AppStrings.therepyPlan, textColor: AppColors.white, iconColor: AppColors.white),
              Expanded(
                child: SingleChildScrollView(
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 20.w),
                      ...
                      children: [
                        ...
                        Center(
                          child: Container(
                            ...
                            child: CustomText(assessmentAndPlanViewModel.ageGroupData.value!.level ?? "", color: AppColors.black1c),
                          ),
                        ),
                        SizeConfig.sH20,
                        Column(
                          ...
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: List.generate(
                                  assessmentAndPlanViewModel.childNameSelectedList.length,
                                  (index) => CustomText(
                                        assessmentAndPlanViewModel.childNameSelectedList[index]['name'],
                                        color: AppColors.white,
                                      )),
                            ),
                            SizeConfig.sH20,
                            ...
                            Column(
                              ...
                              children: List.generate(
                                  ...
                                  (index) => CustomText(
                                        assessmentAndPlanViewModel.subGoalSelectedList[index]['name'],
                                        color: AppColors.white,
                                      )),
                            ),
                            SizeConfig.sH20,
                            ...
                            Column(
                              ...
                              children: List.generate(
                                  ...
                                  (index) => CustomText(
                                        assessmentAndPlanViewModel.currentLevelSelectedList[index]['name'],
                                        color: AppColors.white,
                                      )),
                            ),
                            SizeConfig.sH20,
                            ...
                            Column(
                              ...
                              children: List.generate(
                                  ...
                                  (index) => CustomText(
                                        assessmentAndPlanViewModel.strategiesSelectedList[index]['name'],
                                        color: AppColors.white,
                                      )),
                            )
                          ],
                          ...
                          children: [
                            ...
                            CustomBtn(
                              onTap: () {
                                ...
                                therapyPlanViewModel.setTherapyData(therapistName: userDetail["userName"]);
                                therapyPlanViewModel.generateAndSendPDFOnEmail(context, userEmailId: userDetail["email"]);
                              },
                              height: 55.h,
                              width: 144.w,
                              bgColor: AppColors.white,
