...
class AppImageAssets {
  ...
  /// sign up screen
  static const String signUpAppBarImage =
  ...
  static const String therapistImage =
      '${AppConstants.baseImageAssetsPath}therapist_image.png';

  /// sign in screen
  static const String signInAppBarImage =
      '${AppConstants.baseImageAssetsPath}signInAppBar.png';
  static const String signInManImage =
      '${AppConstants.baseImageAssetsPath}loginManImage.png';
  ...
  static const String sessionSelectedImg =
      '${AppConstants.baseImageAssetsPath}sessionSelected.png';
  static const String profileImg =
      '${AppConstants.baseImageAssetsPath}profile.png';
  static const String profileSelectedImg =
      '${AppConstants.baseImageAssetsPath}receipt-item.png';
  static const String settingSelectedImg =
      '${AppConstants.baseImageAssetsPath}setting-3.png';
  static const String settingImg =
  ...
  static const String profileIcon =
      '${AppConstants.baseIconAssetsPath}profile.svg';
  static const String phoneNoIcon =
      '${AppConstants.baseIconAssetsPath}phoneNoIcon.svg';
  static const String passwordIcon =
      '${AppConstants.baseIconAssetsPath}passwordIcon.svg';
  static const String passwordViewIcon =
      '${AppConstants.baseIconAssetsPath}passwordViewIcon.svg';
  ...
  ///SUBSCRIPTION SCREEN
  static const String tikMarkIcon =
      "${AppConstants.baseIconAssetsPath}tik_mark.png";
  static const String backArrow =
      "${AppConstants.baseIconAssetsPath}back_arrow.png";
  ...
  ///NO INTERNET SCREEN
  static const noInternetImage =
      "${AppConstants.baseImageAssetsPath}no_internet_image.png";

  ///PAYMENT SCREEN IMAGE
  static const paymentImage =
      "${AppConstants.baseImageAssetsPath}payment_image.png";
...
class AppImageAssets {
  ...
  /// User request Screen
  static const String musicImg = '${AppConstants.baseImageAssetsPath}music.png';
  static const String speechImg = '${AppConstants.baseImageAssetsPath}speech.png';
  static const String sportImg = '${AppConstants.baseImageAssetsPath}sports.png';
  static const String therapyImg = '${AppConstants.baseImageAssetsPath}therapy.png';
  static const String specialEducationImg = '${AppConstants.baseImageAssetsPath}specialEducation.png';
  ...
  ///USER REQUEST SCREEN
  static const successIcon =
      "${AppConstants.baseIconAssetsPath}success_icon_component.png";
  static const speechImage = "${AppConstants.baseImageAssetsPath}speech.png";
